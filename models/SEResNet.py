...
class ResNetFeatureExtractor(nn.Module):
    def __init__(self, block, layers, in_channel=12, dropout_rate=0.0):
...
def resnet18(pretrained=False, dropout_rate=0.0, **kwargs):
    """Constructs a ResNet-18 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNetFeatureExtractor(BasicBlock, [2, 2, 2, 2], dropout_rate=dropout_rate, **kwargs)
    if pretrained:
...
def resnet34(pretrained=False, dropout_rate=0.0, **kwargs):
    """Constructs a ResNet-34 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNetFeatureExtractor(BasicBlock, [3, 4, 6, 3], dropout_rate=dropout_rate, **kwargs)
    if pretrained:
...
def resnet50(pretrained=False, dropout_rate=0.0, **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNetFeatureExtractor(Bottleneck, [3, 4, 6, 3], dropout_rate=dropout_rate, **kwargs)
    if pretrained:
...
def resnet101(pretrained=False, dropout_rate=0.0, **kwargs):
    """Constructs a ResNet-101 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNetFeatureExtractor(Bottleneck, [3, 4, 23, 3], dropout_rate=dropout_rate, **kwargs)
    if pretrained:
...
def resnet152(pretrained=False, dropout_rate=0.0, **kwargs):
    """Constructs a ResNet-152 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNetFeatureExtractor(Bottleneck, [3, 8, 36, 3], dropout_rate=dropout_rate, **kwargs)
    if pretrained:
