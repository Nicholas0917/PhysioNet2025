#!/bin/bash
#SBATCH --job-name=PhysioNet_RBBB         # Job name      
...
export PRETRAIN_MODEL_FOLDER='/users/scjb/PhysioNet2025/ECGFounder_add_Augmentation_0731_2/Model'
export VISUALISATION_FOLDER='/users/scjb/PhysioNet2025/ECGFounder_add_Augmentation_0803_1/visualisation'
...
python train_model.py -d /mnt/scratch/wmqn2362/PhysioNet25/train_folder/ \
    -m /users/scjb/PhysioNet2025/ECGFounder_add_Augmentation_0803_1/Model \
    -v
